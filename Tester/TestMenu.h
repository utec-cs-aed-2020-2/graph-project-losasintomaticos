...
void testdDijkstra(){
    ...
    std::cout << "\n\n================================================" << std::endl;
    std::cout << "          ALGORITMO Dijkstra Dirigido" << std::endl;
    std::cout << "================================================" << std::endl;
    cout << "El Grafo de Ejemplo es el siguiente:" << endl;
    graph.display();
    cout << "\nAplicando el Algoritmo Dijkstra Dirigido:\n" << endl;
...
void testuDijkstra(){
    ...
    std::cout << "\n\n================================================" << std::endl;
    std::cout << "      ALGORITMO Dijkstra No Dirigido" << std::endl;
    std::cout << "================================================" << std::endl;
    cout << "El Grafo de Ejemplo es el siguiente:" << endl;
    graph.display();
    cout << "\nAplicando el Algoritmo Dijkstra No dirigido:\n" << endl;
    Dijsktra<string, float> grafito(graph);
    UnDirectedGraph<string, float> grafe = grafito.applyU("A");
    grafe.display();
    std::cout << "\n================================================" << std::endl;
}
